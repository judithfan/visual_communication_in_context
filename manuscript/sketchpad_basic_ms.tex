...
First, we use the empirical estimates $\textrm{sim}(s,o)$ to evaluate the contribution of context and cost sensitivity to explaining human sketch production. Next, using our trained visual encoder, we evaluate the contribution of visual abstraction 
