...
Generally, we found that only models that used abstract visual features and were sensitive to both context and cost displayed a consistent preference for more costly sketches on close trials and less costly sketches on far trials, mirroring human behavior. 

\begin{figure*}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/5_model_results.pdf}
