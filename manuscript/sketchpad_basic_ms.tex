...
We used this modeling framework to conduct a series of lesion studies that test each aspect of our hypothesis about the core cognitive faculties employed by humans to decide which sketch to produce in context. First, we directly use the empirical estimates $\textrm{sim}(s,o)$ to evaluate the contribution of context sensitivity and cost sensitivity. Second, using our trained visual encoder, we evaluate the contribution of visual abstraction. 
