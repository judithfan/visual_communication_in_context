...
% Cite old context-manipulation stuff like Krauss & Weinheimer (1967) which shows colors in 'far' vs. 'close' contexts or Brennan & Clark (1996) which shows that people switch from basic-level term to subordinate term when additional members of basic-level category are added to context... 
