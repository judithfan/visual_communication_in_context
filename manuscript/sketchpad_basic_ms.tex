...
To test our hypothesis, we developed a computational model following this encoder-decoder framework, consisting of a convnet visual encoder module and a probabilistic social inference module. 
