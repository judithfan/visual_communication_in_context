...
Rather, these results suggest that there is an additional crucial role played by semantic context in determining how informative and costly of a sketch people produce during visual communication, a hallmark feature of a phenomenon known as \textit{pragmatics} in analogous scenarios during verbal communication.
...
To test this proposal, we developed a computational model of the sketcher that embodied these three faculties, and was instantiated as a probabilistic program wrapped around a deep convolutional neural network. 
