...
Together, this work provides a first algorithmically explicit theory of how perception and social cognition support contextual flexibility in real-time visual communication.
...
First, obtaining a visual encoder that could produce accurate predictions of perceptual correspondence between sketches and objects for unseen sketches required substantial supervision. 
While heavy supervision is not uncommon for neural network models of sketch representation \cite{sangkloy2016sketchy,yu2017sketch,song2017deep}, future work should investigate alternative visual encoder architectures, including those that exploit abstract correspondences in the hierarchical organization of object structure that may be present in both natural images and sketches \cite{battaglia2016interaction,mrowca2018graph}.
Second, while discretizing the output of our model over the 64 object-context combinations enabled us to test our key hypotheses concerning the joint contributions of visual abstraction and pragmatic inference to contextual flexibility, this is of course quite dissimilar to the action space that human participants in fact navigated when performing the reference game task, wherein they could produce a sequence of strokes of any length anywhere on the canvas. 
While there has been some recent and promising advances in modeling sketch production as a sequence of such actions \cite{lake2015human,ha2017neural,ganin2018synthesizing}, these approaches have not yet been shown to successfully emulate how people sketch real objects, much less how this behavior is modulated by communicative context. 
Future work should develop sketch production that more closely approximates the actual size of the action space inherent to the drawing task. 
Meeting these challenges is not only important for developing more human-like artificial intelligence, but may also shed new light on the nature of human visual abstraction, and how ongoing perception and long-term conceptual knowledge (e.g., that birds have wings, and dogs have four legs) guide action selection. 


% Furthermore, the present study raises several 
