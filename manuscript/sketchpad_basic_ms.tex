...
This work can be thought of as generalizing the Rational Speech Act (RSA) modeling framework, originally developed to explain contextual effects in verbal communication \cite{frank2012predicting,goodman2013knowledge}.
RSA models take inspiration from the insights of Paul Grice \cite{grice1975syntax}, who provided a philosophical framework for understanding how natural language use reflects exquisite social reasoning in context. 
RSA models draw on ideas and insights from decision theory, probabilistic models of cognition, bounded rationality, and linguistics, and have recently been shown to captured a variety of complex linguistic patterns, achieved good quantitative fits with experimental data, and been incorporated into artificial agents that communicate with each other to solve real-world tasks \cite{goodman2013knowledge,kao2014formalizing,monroe2017colors}.
Our findings demonstrate the utility of this modeling approach for nonverbal communication, including sketch production, and suggest a way forward for addressing fundamental questions about how pictorial representations derive meaning.
