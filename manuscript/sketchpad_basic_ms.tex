...
A watershed moment in the history of human communication was the invention of graphical representation, independently in Europe and Asia, about 30-60 thousand years ago \cite{hoffmann2018u,Aubert:2014jy}.

%% The point is that communication is generally important, and that visual communication is an important subtype of communication. 
...
%% Visual communication is generally important, and drawing is an important subtype of visual communication.
...
In particular, a fundamental question

concerns how visual perception and socially learned 

general-purpose visual representations and socially- for explaining how drawings derive their meaning.

On the one hand, there are diverse sources of evidence suggesting that the perceptual system may be sufficient to explain how people are able to perceive their semantic content, in the absence of socially-mediated experience in how to interpret drawings. Recently, it has been shown that features learned by deep convolutional neural network models (DCNNs) trained only to recognize objects in photos and had never seen a line drawing succeed in recognizing simple sketches \cite{fan2015common,yamins2014performance}, suggesting that the ability to perceive the correspondence between drawings and real-world objects can arise from the same general-purpose neural architecture evolved to handle natural visual inputs \cite{Sayim:2011bz,gibson2014ecological}. These findings are consistent with evidence from other domains, including developmental, cross-cultural, and comparative studies of drawing perception. For example, human infants \cite{hochberg1962pictorial}, people living in remote regions without pictorial art traditions and without substantial contact with Western visual media \cite{kennedy1975outline}, and higher non-human primates \cite{tanaka2007recognition} are able to recognize line drawings of familiar objects, even without prior experience with drawings.

On the other hand, several influential theorists have argued that socially-mediated experience with visual artifacts is necessary to be able to interpret pictorial representations, and thus that pictorial competence relies heavily on social cognition. 

On this view, generic visual computations are insufficient to drive perceptual correspondences between drawings and objects --- rather, drawings denote objects through purely culturally-specific conventions much the same way that verbal labels denote objects \citep{goodman1976languages,gombrich1969art}. Indeed, many drawings that people use to communicate are quite sparse, emphasizing information that is most relevant in the current context, and omitting irrelevant details. In the appropriate context, even a few strokes can express the identity of a face \citep{bergmann2013impact}, a suggested route \citep{agrawala2001rendering}, or an intention to act \citep{Galantucci:2005uh}. However, in the absence of contextual cues, such sparse representations may be insufficient to communicate specific meanings \citep{Healey:2007vq}. 
...
Prior work has been equivocal about the relative contribution of these systems for explaining how drawings derive their referential meaning. 
