...
Observing this kind of contextual flexibility in visual communication argues against against the view that there is a unique solution to the problem of pictorial representation that is constrained only by the appearance of the target. Rather, these results suggest that during visual communication, humans are sensitive to the semantic context and to the cost of producing informative depictions, in addition to the target's visual properties. 

To evaluate this explanation directly 
