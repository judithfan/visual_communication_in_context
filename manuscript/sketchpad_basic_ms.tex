...
However, only the pragmatic sketcher displayed context congruity (Fig.~\ref{model_results}B, left); both the context-insensitive and cost-insensitive variants did not (95\% CI: pragmatic = $[XX,XX]$, context-insensitive = $[XX,XX]$, cost-insensitive = $[XX,XX]$). The context-insensitive variant is inherently unable to 
