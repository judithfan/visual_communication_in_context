...
This work can be thought of as generalizing the Rational Speech Act (RSA) modeling framework \cite{frank2012predicting,goodman2013knowledge}.
...
RSA models draw on ideas and insights from decision theory, probabilistic models of cognition, bounded rationality, and linguistics, and have captured a variety of complex linguistic patterns, achieved good quantitative fits with experimental data, and been incorporated into artificial agents that communicate with each other to solve real-world tasks \cite{goodman2013knowledge,kao2014formalizing,monroe2017colors}.
Our findings suggest the utility of this modeling approach for nonverbal communicative behaviors, including sketch production ... and raise several questions XX, YY, ZZ. 
