...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{2_sketch_gallery-min.pdf}
...
\section*{Code availability} The code for the analyses presented in this article is publicly available in a Github repository:
