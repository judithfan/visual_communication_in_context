...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{1_task_display_alt.png}
...
This basic arrangement can be traced back to the language games explored by \cite{wittgenstein1953philosophical} and \cite{Lewis69_Convention}. 
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.99\textwidth]{2_sketch_gallery-min.pdf}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.99\textwidth]{3_behavioral_performance.pdf}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.99\textwidth]{4_model_schematic-min.pdf}
...
\section*{Code availability} The code for the analyses presented in this article is publicly available in a Github repository. \url{https://github.com/judithfan/visual_communication_in_context}.

\section*{Data availability} The data presented in this article is publicly available in a figshare repository.
