...
To evaluate this hypothesis, we investigated the consequences of manipulating communicative context on the drawings people produce during visual communication, finding that people spontaneously modulated how much time and ink they invested in their drawings in order to be sufficiently informative in context. 
To explain these findings, we developed a computational model of visual communciation that embodied two core competencies: visual abstraction, the general capacity to perceive the correspondence between an object and a simple drawing of it; and pragmatic inference, the ability to infer what information is not only \textit{valid} to include in a drawing, but also \textit{relevant} in context  \cite{goodman2016pragmatic,grice1975syntax,abell2009canny}.
