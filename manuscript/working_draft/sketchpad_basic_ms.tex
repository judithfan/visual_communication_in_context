...
Unsurprisingly, this model did not perform as well as the pragmatic sketcher model from the previous section that could operate directly on human recognition data (median Bayes Factor = $105.71$).
