...
posterior = read_csv('./enumerateOutput.csv') %>%
  distinct() %>% 
...
humanPosterior %>%
  ...
  mutate(BF = 1/exp(posterior - prior))
...
* Inside 3 vision models, compare vision models
...
modelPosterior %>%
  ...
  summarize(BF_fc6_conv42 = exp(multimodal_fc6 - multimodal_conv42),
            BF_fc6_pool1  = exp(multimodal_fc6 - multimodal_pool1))
