...
The goal of the proposed experiment is twofold: to reveal how people negotiate graphical conventions for expressing abstract meanings through repeated interactions, and to understand the general consequences of such interaction history on subsequent communication of novel meanings. 

To accomplish this, we plan to develop a graphical-dialogue paradigm in which one participant (Artist) has the goal of producing drawings of objects that the other participant (Viewer) will be able to identify. To investigate the importance of interaction history, we will manipulate how many different objects they will practice on before they are tested on a set of novel objects. 
