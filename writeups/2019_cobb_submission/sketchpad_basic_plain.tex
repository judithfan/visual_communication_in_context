...
For the base encoder, we employ a widely used and high-performing deep convolutional neural network architeceture, VGG-19, pretrained to recognize objects from the Imagenet database, whose parameters remain frozen \cite{simonyan2014very,deng2009imagenet}. 
