...
\revised{Nevertheless, this cost-insensitive variant still produced consistently costlier sketches in close contexts than in far contexts. This can be understood as being driven by the diagnosticity component of the informativity term: because the cost-insensitive variant continues to place a higher utility on sketches that are diagnostic of the target in context, in close contexts it is biased to produce the most diagnostic sketches, which are also costlier close sketches. By contrast, in far contexts, both close and far sketches may be similarly diagnostic, and thus the model produces a mixture of these sketch types.}
...
and the high vs. low column inclues comparisons between between model variants using a high adaptor vs. low adaptor in context/cost-sensitive model.}
